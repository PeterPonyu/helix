...
├── identity.ts             # buildIdentitySection() — helix neutral identity
...
| Task | File |
|------|------|
| Change helix identity | `identity.ts` |
...
1. **Identity** — helix-neutral hero line
...
- Replacing the helix identity with `"You are a helpful assistant."` — was tried, produced weak generic-bot output, reverted 2026-04-30.
