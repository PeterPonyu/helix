...
export function renderWebfetchCall(args: WebfetchArgs, theme: typeof ThemeInstance): Text {
...
function previewText(text: string, theme: typeof ThemeInstance): string[] {
	const lines = text
		.split("\n")
		.map((line) => line.trim())
