	...
	test("self-updates renamed packages from the current install prefix", () => {
		...
		expect(command).toEqual({
			...
			steps: [
				{
					command: "npm",
					args: ["--prefix", prefix, "uninstall", "-g", "@helix-bio/helix"],
					display: `npm --prefix ${prefix} uninstall -g @helix-bio/helix`,
				},
				{
					command: "npm",
					args: ["--prefix", prefix, "install", "-g", "@new-scope/pi"],
	...
	test("self-updates renamed pnpm global installs by removing the old package first", () => {
		...
		expect(command).toEqual({
			...
			steps: [
				{
					command: "pnpm",
					args: ["remove", "-g", "@helix-bio/helix"],
					display: "pnpm remove -g @helix-bio/helix",
				},
				{
					command: "pnpm",
					args: ["install", "-g", "@new-scope/pi"],
	...
	test("self-updates renamed yarn global installs by removing the old package first", () => {
		...
		expect(command).toEqual({
			...
			steps: [
				{
					command: "yarn",
					args: ["global", "remove", "@helix-bio/helix"],
					display: "yarn global remove @helix-bio/helix",
				},
				{
					command: "yarn",
					args: ["global", "add", "@new-scope/pi"],
	...
	test("self-updates renamed bun global installs by removing the old package first", () => {
		...
		expect(command).toEqual({
			...
			steps: [
				{
					command: "bun",
					args: ["uninstall", "-g", "@helix-bio/helix"],
					display: "bun uninstall -g @helix-bio/helix",
				},
				{
					command: "bun",
					args: ["install", "-g", "@new-scope/pi"],
