...
// ============================================================================
// OAuth API key resolution from the agent config dir (~/.helix/agent/auth.json,
// or HELIX_CODING_AGENT_DIR when set — matches test/setup.ts quarantine).
// ============================================================================
...
/**
 * Resolve API key for a provider from the agent config dir's auth.json
 * (~/.helix/agent/auth.json, or HELIX_CODING_AGENT_DIR when set).
 *
...
/**
 * Check if a provider has credentials in the agent config dir's auth.json
 * (~/.helix/agent/auth.json, or HELIX_CODING_AGENT_DIR when set).
 */
...
/** Path to the helix agent config directory (~/.helix/agent, or HELIX_CODING_AGENT_DIR). */
export const HELIX_AGENT_DIR = getAgentDir();

/**
 * Get an AuthStorage instance backed by the agent config dir's auth.json
 * (~/.helix/agent/auth.json, or HELIX_CODING_AGENT_DIR when set).
