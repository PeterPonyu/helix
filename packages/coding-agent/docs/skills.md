...
Discovery rules:
- In `~/.helix/agent/skills/` and `.helix/skills/`, direct root `.md` files are discovered as individual skills
...
For project-level Claude Code skills, add to `.helix/settings.json`:
